// console.log("hola_ctrl register");
        ...
        ajaxPromise('module/auth/controller/controller_auth.php?op=register', 'POST', 'JSON', data)
            .then(function(result) {
                ...
                if (result == "error_email") {
                    document.getElementById('error_email_reg').innerHTML = "El email esta en uso, asegurate de no tener ya una cuenta"
                } else if (result == "error_user") {
                    document.getElementById('error_username_reg').innerHTML = "El usuario esta en uso, intentalo con otro"
                } else {
